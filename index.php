        ...
        <!--counter*/-->
          ...
          <ul class="slides-container">
            ...
            <li>
              ...
              <img src="images/sarajevo.jpg" alt="img">
              <!-- FIRST SLIDE CAPTION-->
            ...
            <li>
              ...
              <img src="images/sarajevo1.jpg" alt="img">
            ...
            <li>
              ...
              <img src="images/sarajevo3.jpg" alt="img">
              <!-- THIRD SLIDE CAPTION-->
              <div class="slider_caption">                 
              </div>
            </li>
                    ...
                    <div class="about_slider">
                      ...
                      <div class="featured_slider">
                        ...
                        <div class="single_iteam">
                          <img src="images/ema1.jpg" alt="img">                          
                        </div>
                        <!-- SINGLE SLIDE IN THE SLIDER -->
                        <div class="single_iteam">
                          <img src="images/ema6.jpg" alt="img">                          
                        </div>
                        <!-- SINGLE SLIDE IN THE SLIDER -->
                        <div class="single_iteam">
                          <img src="images/ema3.jpg" alt="img">                           
                        </div>
                        <!-- SINGLE SLIDE IN THE SLIDER -->
                        <div class="single_iteam">
                          <img src="images/ema4.jpg" alt="img">                           
                        </div>
                        <!-- SINGLE SLIDE IN THE SLIDER -->
                        <div class="single_iteam">
                          <img src="images/ema5.jpg" alt="img">                           
                        </div>
                      </div>
                      <!-- END FEATURED SLIDER -->
                    </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="about_area">
              <!-- START NEWS HEADING -->
              <div class="heading" style="margin-top:120px">
                <h2 class="wow fadeInLeftBig">NEWS</h2>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="about_slider">
                      <!-- BEGAIN FEATURED ITEAM -->
                      <div class="featured_slider">
                        <!-- SINGLE SLIDE IN THE ITEAM -->
                        <div class="single_iteam">
                          <img src="images/hostel.jpg" alt="img">                          
                        </div>
                      <!-- END FEATURED SLIDER -->
                    </div>
                  </div>
      ...
      <div class="container">
        <div class="row">
  		...
  		<div class="tuna">
      		<ul>
		<div class="heading" >
                	<h5 class="wow fadeInLeftBig">Organizing Committee</h5>
              	</div>
         		<li><p>Nejra Škandro <br>Head organizer</p>
         		<img alt="nejra" src="images/organizers/NejraSkandro.jpg"></li>
         	</ul>
		...
		<ul>
			<li><p>Anesa Selimović<br>FR Team Leader</p><img alt="anesa" src="images/organizers/anesa.jpg"></li>
         		...
         		<li><p>Nejra Bahtić <br>HR Team Leader</p><img alt="nejra" src="images/organizers/Nejra Bahtić.jpg"></li>
         		<li><p>Tarek-Abdurazzak Chahin<br>PR Team Leader</p><img alt="tarek" src="images/organizers/tarek.jpg"></li>
	     		<li><p>Emir Torlak<br>Design Team Leader</p><img alt="emir" src="images/organizers/EmirTorlak.jpg"></li>
         		<li><p>Elma Sinanović<br>Contact Person</p><img alt="elma"src="images/organizers/ElmaSinanović.jpg"></li>
         		<!-- START board of directors-->
		
		<div class="heading" style="margin-top:60px">
                	<h5 class="wow fadeInLeftBig">Board of LC SARAJEVO</h5>
              	</div>
		...
		<div class="heading" style="margin-top:60px">
                	<h5 class="wow fadeInLeftBig">Oversight Committee</h5>
              	</div>
			<!-- START supervisory Board-->
			<div id="no">
			<li><p>Amina Žgalj</p><img alt="amina" src="images/organizers/Amina Žgalj.jpg"></li>
	     		<li><p>Semra Ćurevac</p><img alt="semra" src="images/organizers/Semra Curevac.jpg"></li>   
			<li><p>Mirza Kupusović</p><img alt="mirza" src="images/organizers/MirzaKupusović.jpg"></li> 
			</div>    
      		</ul>
		</div>
             </div>
...
<div style="clear:both;"></div>
    ...
    <section id="partners">
      <div class="container">
		...
		<div class="panel-heading">
                            <h5>Exclusive partner</h5>
                            <div id="smg">
                            <ul style="disply: inline;">
        				<li><img src="img/Logos/Simurg Media - Golden-1.png" alt="SMG"/></li>
        		   </ul>
        		   </div>
                    	</div>
		</div>
...
/*Counter*/
  function counter(){
   // $('.begins').hide('slow');
                $('.slides-navigation').show('slow');
                var v = new Date().getTime() / 1000;
                var k = new Date("2015-08-13 00:00:00.00").getTime() / 1000; 
                var sekundi = k - v;
                $('.sekundi').empty().html(Math.floor(sekundi % 60));
                $('.minuta').empty().html(Math.floor((sekundi % 3600) / 60));
                $('.sati').empty().html(Math.floor((sekundi % 86400) / 3600));
                $('.dan').empty().html(Math.floor(sekundi / 86400));
            }
